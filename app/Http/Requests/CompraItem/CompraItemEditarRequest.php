...
class CompraItemEditarRequest extends FormRequest
{
    ...
    {
        return [
            'id'                    => ['required', 'integer', Rule::exists('compras_itens', 'id')->whereNull('deleted_at')],
    ...
    {
        return [
            'id.required'                    => 'O identificador do item da compra é obrigatório.',
            'id.exists'                      => 'O item da compra informado não existe.',
